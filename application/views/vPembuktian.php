		...
		<div class="pd-ltr-20">
		   ...
		   <div class="col-sm-12 col-md-12 mb-30">
				<div class="card card-box">
					<form action="<?php echo site_url()?>/perkara/pembuktianSimpan" method="post" enctype="multipart/form-data">
					<div class="card-header">
						Tahapan Perkara Pembuktian
					</div>
					<div class="card-body">
                        <?php echo $pesan;?>					
						...
						<div class="form-group row">
							<label class="col-md-2 col-form-label">Saksi-Saksi</label>
							<div class="col-md-10">
								<textarea name="saksi" rows="2" class="form-control"><?php echo (!empty($perkara->saksi_saksi) ?  $perkara->saksi_saksi : set_value('saksi') ); ?></textarea>
								<?php echo form_error('saksi'); ?>
							</div>								
						</div>
						<div class="form-group row">								
