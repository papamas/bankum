...
<body>
			...
			<!-- Responsive tables Start -->
				<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">						
							<h4 class="text-blue h4">Daftar Approval Surat Perintah Penunjukan Saksi/Ahli</h4>	
							 <?php echo $pesan; ?>
							<form name="frmDaftar" action="<?php echo site_url()?>/approval" method="post">
	    ...
	    <div class="modal-dialog  md-dialog modal-lg">
		  <div class="modal-content md-content">
				<div class="modal-header">
					<h4 class="modal-title">Pratinjau Surat Penunjukan</h4>
	...
	$(document).ready(function () {
		...
		$('#kirimModal').on('show.bs.modal',function(e){
			 $('#kirimModal #msg').text('Konfirmasi Approval Penunjukan')
		...
		function refreshTable(){						
			$.ajax({   
			    type: 'POST',   
			    url: '<?php echo site_url()?>/approval/getPenunjukan',   
