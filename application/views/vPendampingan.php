...
<body>
		   ...
		   <div class="col-sm-12 col-md-12 mb-30">
				<div class="card card-box">
					<div class="card-header">
						Tambah Data Surat Perintah Pendampingan Saksi/Ahli
					</div>
					<form  id="fpratinjau" action="<?php echo site_url()?>/pendampingan/simpan" method="post">
					<div class="card-body">
						<?php echo $pesan;?>				
							...
							<div class="form-group row">
								...
								<div class="col-md-4">
									<input name="tanggalSurat" class="form-control date-picker" type="text" placeholder="Tanggal Surat">
								</div>
							</div>
	...
	$(document).ready(function () {
		$('#pratinjauSurat').on('show.bs.modal',function(e) {    		
			...
			var iframe = $('#frame');
			iframe.attr('src', '<?php echo site_url()?>'+'/pendampingan/pratinjau/?'+ data);			
	    });
