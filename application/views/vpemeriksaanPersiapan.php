		...
		<div class="pd-ltr-20">
		   ...
		   <div class="col-sm-12 col-md-12 mb-30">
				<div class="card card-box">
					<form action="<?php echo site_url()?>/perkara/pemeriksaanPersiapanSimpan" method="post" enctype="multipart/form-data">
					<div class="card-header">
						Tahapan Perkara Pemeriksaan Persiapan
					</div>
					<div class="card-body">
                        <?php echo $pesan;?>					
						<div class="form-group row">
							...
							<input type="hidden" name="suratKuasaOld" value="<?php echo $perkara->surat_kuasa?>" />
							<input type="hidden" name="suratPerintahOld" value="<?php echo $perkara->surat_perintah?>" />
							<input type="hidden" name="suratIjinInsidentilOld" value="<?php echo $perkara->surat_ijin_insidentil?>" />
						...
						<div class="form-group row">								
							<label class="col-md-2 col-form-label">Surat Kuasa</label>
							<div class="col-md-4">
								<input type="file" name="suratKuasa" class="form-control" />
								<a style="color:blue;" class="<?php echo (!empty($perkara->tanggal_sidang) ?  '' : 'd-none') ?>" data-toggle="modal"  data-tooltip="tooltip" data-placement="top" title="Lihat Surat" data-target="#fileSurat" data-id="?f=<?php echo $this->myencrypt->encode($perkara->surat_kuasa)?>"><i class="fa fa-eye"> Lihat File</i></a>
							</div>
							<label class="col-md-2 col-form-label">Surat Perintah</label>
							<div class="col-md-4">
								<input type="file" name="suratPerintah" class="form-control" />
								<a style="color:blue;" class="<?php echo (!empty($perkara->tanggal_sidang) ?  '' : 'd-none') ?>" data-toggle="modal"  data-tooltip="tooltip" data-placement="top" title="Lihat Surat" data-target="#fileSurat" data-id="?f=<?php echo $this->myencrypt->encode($perkara->surat_perintah)?>"><i class="fa fa-eye"> Lihat File</i></a>
							</div>
						</div>
						<div class="form-group row">								
							<label class="col-md-2 col-form-label">Surat Ijin Insidentil</label>
							<div class="col-md-4">
								<input type="file" name="suratIjinInsidentil" class="form-control" />
								<a style="color:blue;" class="<?php echo (!empty($perkara->tanggal_sidang) ?  '' : 'd-none') ?>" data-toggle="modal"  data-tooltip="tooltip" data-placement="top" title="Lihat Surat" data-target="#fileSurat" data-id="?f=<?php echo $this->myencrypt->encode($perkara->surat_ijin_insidentil)?>"><i class="fa fa-eye"> Lihat File</i></a>
							</div>
