		...
		<div class="pd-ltr-20">
		   ...
		   <div class="col-sm-12 col-md-12 mb-30">
				<div class="card card-box">
					<form action="<?php echo site_url()?>/perkara/suratPanggilanSimpan" method="post" enctype="multipart/form-data">
					<div class="card-header">
						Tahapan Perkara Surat Panggilan
					</div>
					<div class="card-body">
                       <div class="form-group row">
							...
							<input type="hidden" name="dokumenIntervensiOld" value="<?php echo $perkara->dokumen_intervensi?>" />
						...
						<div class="form-group row">								
							<label class="col-md-2 col-form-label">Dokumen Intervensi</label>
							<div class="col-md-4">
								<input type="file" name="dokumenIntervensi" class="form-control" />
								<a style="color:blue;" class="<?php echo (!empty($perkara->tanggal_sidang) ?  '' : 'd-none') ?>" data-toggle="modal"  data-tooltip="tooltip" data-placement="top" title="Lihat Surat" data-target="#fileSurat" data-id="?f=<?php echo $this->myencrypt->encode($perkara->dokumen_intervensi)?>"><i class="fa fa-eye"> Lihat File</i></a>
							</div>
